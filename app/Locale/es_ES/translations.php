...
return array(
    ...
    'Application design' => 'Diseño de la aplicación',
    'Language' => 'Idioma',
    ...
    'Upload' => 'Cargar',
    'Logo file' => 'Archivo logo de aplicación',
    'You must select a file!' => 'Debe seleccionar un archivo',
    'The file is not a valid image (Only *.gif, *.jpg, *.jpeg and *.png are allowed!)' => 'El archivo no es una imagen válida (Solo *.gif, *.jpg, *.jpeg and *.png son permitidas!)',
