<h1>
    <span class="logo">
        <?php if (! empty($this->app->config('application_logo'))): ?>
            <?= $this->url->link($this->app->renderImageAvatar('application_logo'), 'DashboardController', 'show', array(), false, '', t('Dashboard')) ?>
        <?php else: ?>
