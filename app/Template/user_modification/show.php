...
<form method="post" action="<?= $this->url->href('UserModificationController', 'save', array('user_id' => $user['id'])) ?>">
    ...
    <fieldset>
        ...
        <?= $this->form->date(t('Date of Birth'), 'date_of_birth', $values, $errors, array($this->user->hasAccess('UserModificationController', 'show/edit_date_of_birth') ? 'autocomplete="date_of_birth"' : 'readonly')) ?>
    </fieldset>
